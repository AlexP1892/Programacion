 ...
 * @author User
 */
public class ClienteViewGUI extends javax.swing.JFrame {
    
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ClienteViewGUI.class.getName());
    private ClienteController controller;

    /**
     * Creates new form ClienteViewGUI
     */
    public ClienteViewGUI() {
        initComponents();
        initComponents();
        setTitle("Cliente MVC");
    ...
    public void mostrarDatosCliente(int id, String nombre, String apellido) {
...
@SuppressWarnings("unchecked")
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         if (controller != null) {
            ...
            if (newNombre == null || newNombre.trim().isEmpty()) {
                ...
                controller.setNombre(newNombre);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ClienteViewGUI().setVisible(true));
    }
